...
#################################################################
with open("./params_simulation.yml", "rb") as f:
    params_simulation = yaml.safe_load(f)

# num_simulations = params_simulation["num_simulations"]
# lst_num_sample = params_simulation["lst_num_sample"]
# lst_dim = params_simulation["lst_dim"]
#
#
# HACK:
# num_simulations = 2
...
for sim in range(num_simulations):
    ...
    logger.info(f"--- Scenario iter {sim} num_sample = {num_sample} and dim = {dim} ---")
