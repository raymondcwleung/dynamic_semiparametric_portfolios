...
\newcommand{\ind}{\ensuremath\boldsymbol{1}} % indicator function 
\newcommand{\indsmall}[1]{\ensuremath\boldsymbol{1}_{\{#1\}}} % small indicator function 
...
% General functions 
\newcommand{\Efr}{\ensuremath\mathsf{erf}} % error function 
